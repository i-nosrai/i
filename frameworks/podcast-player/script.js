...
const togglePlay = () => {
  ...
  if (isPlaying) {
    playButtonIcon.src = "frameworks/podcast-player/assets/icons/pause.svg";
  } else {
    playButtonIcon.src = "frameworks/podcast-player/assets/icons/play.svg";
  }
};
...
const toggleMute = () => {
  ...
  if (isMuted) {
    volumeIcon.src = "frameworks/podcast-player/assets/icons/mute.svg";
    volumeSlider.disabled = true;
  } else {
    volumeSlider.disabled = false;
    volumeIcon.src = "frameworks/podcast-player/assets/icons/volume.svg";
  }
};
...
wavesurfer.load("frameworks/podcast-player/assets/audio/sample.mp3");
